...
@interface UserPopupViewController : BaseViewController
{
    ...
    NSMutableArray <User*> *selectedUsers;
...
@property (nonatomic, strong) UsersBlock usersBlock;
