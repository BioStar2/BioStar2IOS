...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        //titleLabel.font = [UIFont boldSystemFontOfSize:CSToastFontSize]; [UIFont fontWithName:@"Roboto-Bold" size:companyKey.font.pointSize];
        titleLabel.font = [UIFont fontWithName:@"Roboto-Bold" size:21];
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont fontWithName:@"Roboto-Bold" size:18];
        messageLabel.lineBreakMode = NSLineBreakByWordWrapping;
        //messageLabel.textColor = [UIColor whiteColor];
        messageLabel.textColor = UIColorFromRGB(0xdfdfdf);
        //[NSArray arrayWithObjects:(id)UIColorFromRGB(0x362c2f).CGColor, (id)UIColorFromRGB(0x362c2f).CGColor, nil];
...
#warning 오픈소스 수정부분
    //messageLabel.frame = CGRectMake(messageLabel.frame.origin.x, 0.0, messageLabel.frame.size.width, wrapperView.frame.size.height);
#warning 오픈소스 수정부분
    return wrapperView;
}
